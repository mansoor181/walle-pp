...
# this script is run initially to setup wandb and train the model with baseline config (ab:igfold and ag:esm2)
...
###### test ########
# ./train-walle/scripts/train.sh --mode train --notes "Training the model" --run_tags tag1 tag2