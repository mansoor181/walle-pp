"""
This script calculates the mean and standard deviation of evaluation metrics across all samples. It performs the following tasks:
    - Takes a directory containing JSON files (output from evaluate_on_walle.py).
    - Computes mean, standard deviation, and standard error for metrics like MCC, ROC-AUC, precision, recall, F1-score, TP, TN, FP, FN.
    - Separates metrics into two categories:
        - Node-Level Metrics: Metrics for epitope residue prediction.
        - Link-Level Metrics: Metrics for bipartite graph edge reconstruction.
    - Prints the mean and standard deviation of metrics to the console.
